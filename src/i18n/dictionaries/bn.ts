...
export const bn: Dictionary = {
  ...
  wallet: {
    ...
    topupSuccess: "Top-up সফল — আপনার balance আপডেট হয়েছে।",
    topupFailed: "Top-up হয়নি — আবার চেষ্টা করুন।",
    ...
    errors: {
      ...
      topupNotFound: "Top-up পাওয়া যায়নি।",
      topupNotPending: "এই top-up আর confirm করা যাবে না।",
