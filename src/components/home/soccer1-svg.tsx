// Soccer phase 1 illustration. Strokes use `currentColor` so the parent
// HeroAnimation can theme them via `color: var(--primary)`. Fills stay as
// low-opacity white accents to keep the original look on dark backgrounds.

export function Soccer1SVG() {
  return (
    <svg
      id="soccer1"
    ...
    >
      ...
      >
        ...
        <g
          ...
          style={{ fill: "none", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: 2 }}
        >
      ...
      <g className="soccer1_fill" data-name="FILL">
        ...
        <polygon fill="#FFFFFF" points="2232.9,2090.8 2349.6,2198.7 2392.2,2183.4 2425.4,2148.7" opacity={0.2} />
      ...
      <g className="soccer1_extra-line" data-name="Extra Line">
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="753,1032.3 1,406 832.1,1366.1 1132.1,1348.1 795.2,1067.5" />
        <line x1={998.3} x2={1159.1} y1={683.3} y2={1378.1} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={1001.2} x2={987.1} y1={859.6} y2={677.3} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={1036.1} x2={1004.8} y1={1309.1} y2={905.1} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={587} x2={759.1} y1={788} y2={1028} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="790,1071.2 952.1,1297.1 103,928.1 199,247 545.3,730" />
        <line x1={541.5} x2={103} y1={771} y2={928.1} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={924.5} x2={614.5} y1={633.7} y2={744.8} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="1573.2,1426.1 1033.1,1261.1 595.1,337 915.8,565.8" />
        <line x1={892.3} x2={1} y1={594.1} y2={406} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="1239.4,1164.8 205,1339.1 942.5,650" />
        <line x1={1558.2} x2={1308} y1={1111.1} y2={1153.3} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={982.6} x2={605.6} y1={875.9} y2={771.3} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="1312.8,844.7 1603.2,1048.1 1029.6,889" />
        <line x1={1033} x2={1264.2} y1={648.7} y2={810.7} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={982.1} x2={982.1} y1={538.7} y2={160} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={1253.9} x2={1013.3} y1={1129.9} y2={672.4} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <line x1={1468.2} x2={1288.8} y1={1537.2} y2={1196.1} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="1233.6,458.1 670.1,1 922.8,557.5" />
        <line x1={1286.7} x2={1260.7} y1={792.7} y2={505.7} fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} />
        <polyline fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth={2} points="973.9,670.2 1351.1,1501.2 1293.2,863.5" />
        <g>
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="886.9,599.3 951.6,520.5 1004,549 1068,609.2 1002.6,684.3 950.9,659.5 888.3,597.6" />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} points="889.3,598.6 940.8,627.7 1002,685.5" />
          <line x1={940.8} x2={1004} y1={627.7} y2={549} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} />
        </g>
        <g>
          <polygon fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="1240,439.7 1226.8,472.2 1244.9,509 1288.4,502.9 1300.8,470 1282.9,434.6" />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="1245.7,508 1259.2,474.5 1242,440.8" />
          <line x1={1260} x2={1300.8} y1={475.1} y2={470} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} />
        </g>
        <g>
          <polygon fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="550.7,715.7 534.3,763 553.8,781.9 598.6,791.8 615.2,744.1 595.2,726.1" />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="554.3,780.7 570.5,733.6 552.7,717.4" />
          <line x1={615.2} x2={570.5} y1={744.1} y2={733.6} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} />
        </g>
        <g>
          <line x1={783.7} x2={767.3} y1={1075.3} y2={1037.9} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} />
          <polygon fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} points="743.7,1039.1 762.6,1076.7 783.7,1075.3 816.3,1055 797.8,1018.2 776.1,1019" />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} points="744.9,1039.7 767.3,1037.9 797.2,1018.6" />
        </g>
        <g>
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} points="991,856.1 978.8,888.6 991,902.4 1021.1,910.4 1034.3,878.2 1021,865.1 990.5,856.3" />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} points="990.8,857.2 1003.8,870.2 1032.6,877.6" />
          <line x1={991} x2={1003.8} y1={902.4} y2={870.2} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={2} />
        </g>
        <g>
          <polygon fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="1258.8,815.9 1264.2,844.1 1293.3,862.3 1321.1,839.5 1314.3,810.5 1286.4,793.4" />
          <line x1={1288.1} x2={1314.3} y1={833.9} y2={810.5} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="1260,817.3 1288.1,833.9 1292.8,861.5" />
        </g>
        <g>
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="1261.1,1121.2 1297.5,1139.3 1311.8,1159.1 1288.8,1197.5 1249.8,1180.1 1236.3,1160.4 1261.1,1121.2" />
          <polyline fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} points="1249.8,1180.1 1274.6,1142.3 1261.1,1122.4" />
          <line x1={1310.5} x2={1275.1} y1={1159.1} y2={1142.5} fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={3} />
        </g>
      </g>
      <g
