...
export const slotMinutesSchema = z
  .number()
  .int("turfOwner.errors.wholeMinutes")
  .min(30, "turfOwner.errors.slotMinutesMin")
  .max(180, "turfOwner.errors.slotMinutesMax")
  .refine((v) => v % 5 === 0, "turfOwner.errors.slotMinutesStep")

const hhmmSchema = z.string().regex(/^\d{2}:\d{2}$/, "booking.errors.timeFormat")
